...
| Specification requirement                                    | Where held                                                                                                                                                                                             |
| ------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Section 13.1: board scene, piece models, external stacks     | `packages/game-ui/src/scene/{description,layout}.ts`, `packages/game-ui/test/scene-description.test.tsx`; appendix P5.2                                                                                |
| Section 13.1: constrained camera, local reserve nearest      | `packages/game-ui/src/scene/camera.ts`, `packages/game-ui/test/camera.test.ts`; appendix P5.3                                                                                                          |
| Section 13.3: piece selection and legal destination display  | `packages/game-ui/src/interaction/*`, `packages/game-ui/test/{interaction,flat-board}.test.tsx`                                                                                                        |
